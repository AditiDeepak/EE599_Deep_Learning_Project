...
for i in range(len(input_images)):
  ...
  #  trimap_path = "/home/ec2-user/AWS-EE599/AWS/trimap_images/"
   # target_path = "/home/ec2-user/AWS-EE599/AWS/target_images/"
    ...
    if not os.path.exists("/home/ec2-user/AWS-EE599/AWS/trimap_images/"):
        os.makedirs( "/home/ec2-user/AWS-EE599/AWS/trimap_images/")
    if not os.path.exists("/home/ec2-user/AWS-EE599/AWS/target_images/"):
        os.makedirs("/home/ec2-user/AWS-EE599/AWS/target_images/")
    trimap_path = "/home/ec2-user/AWS-EE599/AWS/trimap_images/"
    target_path = "/home/ec2-user/AWS-EE599/AWS/target_images/"
   ...
   # except:
    ...
    background_image = cv2.imread(random.choice(glob('/home/ec2-user/AWS-EE599/AWS/background_images/*.jpeg')))
...
class Background_Removal_Dataset(torch.utils.data.Dataset):
    def __init__(self, input_path,trimap_path,target_path):
        ...
        self.transform = transforms.Compose([transforms.Resize((240,320)),transforms.ToTensor(),transforms.Normalize(mean=[0.5],std=[0.5])])
...
def train():
    ...
    for i in range(Config['num_epochs']):
        ...
        torch.save(generator.state_dict(), os.path.join(Config['gen_model_path'], 'generator_final.pth'))
        torch.save(discriminator.state_dict(), os.path.join(Config['disc_model_path'], 'discriminator_final.pth'))
    print("Done Training..!")
